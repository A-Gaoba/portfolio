...
const Home = () => {
  ...
  return (
    <section className="bg-[url(assets/coding.gif)] bg-no-repeat md:h-screen h-aout flex justify-center items-center w-full bg-center bg-dunes bg-cover md:-mt-24">
